...
<section class="editable-element" style="padding:100px 20px; text-align:center;">
    ...
    <p class="editable-element">Start building something amazing 🚀</p>
        ...
        this.pluginLibrary = [
            ...
            {
                name: "Lucide",
                description: "Beautiful customizable SVG icon library.",
                tag: `<script src="https://unpkg.com/lucide@latest"><\/script>`
            },
 
            {
                name: "Font Awesome",
                description: "Massive icon pack with brands and UI icons.",
...
href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">`
            ...
            {
                name: "Bootstrap",
                description: "Popular responsive UI framework with components.",
                tag: `
<link rel="stylesheet"
...
`
            ...
            {
                name: "Leaflet",
                description: "Interactive open-source map library.",
                tag: `
<link rel="stylesheet"
...
`
            ...
            {
                name: "CodeMirror",
                description: "Powerful browser code editor component.",
                tag: `
<link rel="stylesheet"
...
`
            ...
            {
                name: "Swiper",
                description: "Modern touch slider and carousel framework.",
                tag: `
<link rel="stylesheet"
...
`
            ...
            {
                name: "Typed.js",
                description: "Animated typing text effect library.",
            ...
            {
                name: "Firebase",
                description: "Backend platform with auth and database tools.",
                tag: `
...
`
            ...
            {
                name: "jQuery",
                description: "Classic DOM manipulation and utility library.",
                tag: `<script src="https://code.jquery.com/jquery-3.7.1.min.js"><\/script>`
            },
 
            {
                name: "React",
                description: "Component-based frontend JavaScript framework.",
                tag: `
...
`
    ...
    addElement(type, parent) {
        ...
        switch (type) {
            ...
            case 'h2':
                ...
                break;
            case 'p':
                el.innerText = 'Start typing content here...';
                break;
            case 'section':
                el.style.width = '100%';
    ...
    moveUp() {
        if (this.selected && this.selected.previousElementSibling) this.selected.parentNode.insertBefore(this.selected, this.selected.previousElementSibling);
        this.record();
    }
    moveDown() {
        if (this.selected && this.selected.nextElementSibling) this.selected.parentNode.insertBefore(this.selected.nextElementSibling, this.selected);
        this.record();
    }
